...
<form id="add-students" method="POST" action="index.php">
...
<hr class="blackHr">
<p>Update Grades</p>
<form id="add-grades" method="POST" action="index.php">
...
?>
    ...
    <div style="font-size: 125%;">
      Welcome to the site: <span style="color: red; text-transform: uppercase;"><?php echo $_SESSION['username']; ?></span>
    </div>
